		...
		<div id="footer">
			<div id="footerContents">
                <div id="footer1">
                    ...
                    Blog systems developed by <a href="http://www.themightymo.com" target="_blank" rel="nofollow">The Mighty Mo! Design Co.</a><br />
                    </p>
                </div><!-- .footer1 -->
                ...
                <div id="footer2">
                	<div class="footerItem footerProvidedBy">
                        <p>Provided by</p>
                        <a href="http://www.authenticityconsulting.com/" target="_blank" rel="nofollow">
